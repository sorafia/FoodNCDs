...
<body>
	...
	<div class="all-page-title page-breadcrumb">
		<div class="container text-center">
			<div class="row">
				<div class="col-lg-12">
					<h1>ความสำคัญของอาหารและโรค NCDs </h1>
				</div>
			</div>
		</div>
	</div>
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="heading-title text-center">
						<h2>โรค NCDs</h2>
						<p>กลุ่มโรค NCDs คือ กลุ่มโรคไม่ติดต่อเรื้อรัง เกิดจากพฤติกรรมในการใช้ชีวิต</p>
						<p>เช่น โรคหัวใจ โรคเบาหวาน โรคความดันโลหิต โรคไต โรคไขมันในเส้นเลือดและโรคกระดูกพรุน เป็นต้น</p>
					</div>
				</div>
			</div>
			<div class="row">
